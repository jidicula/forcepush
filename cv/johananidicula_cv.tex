...
\href{https://jidicula.github.io/images/micropattern.jpg}{Microcontact Printing}, Quantitative Confocal Microscopy, Mammalian Cell Culture, Plasmid Purification, Bacterial Cell Culture


\section*{\href{https://github.com/jidicula}{Languages I know}}

\textbf{Programming:} {\tt Java, Python, MATLAB, R}

\textbf{Markup:} {\tt HTML, CSS, LaTeX}

\textbf{Natural:} {\tt French (conversational and basic reading)}

%\section*{Languages I'm learning}
%
%R, Basic French
